...
/*
 * Trait for creating a Field for storing a "foreign key". Stores a
 * DBRef in the db. Caches the item after fetching. Requires setFromAny
 * accept a DBRef. Versions are available for ObjectId, UUID, String,
 * Int, and Long.
...
trait MongoRefField[RefType <: MongoRecord[RefType], MyType] extends TypedField[MyType] {
  ...
  */
  ...
  /*
   * Get the DBRef value that this Field represents. This is what
...
class ObjectIdRefField[OwnerType <: MongoRecord[OwnerType], RefType <: MongoRecord[RefType]](rec: OwnerType, rm: MongoMetaRecord[RefType])
...
class UUIDRefField[OwnerType <: MongoRecord[OwnerType], RefType <: MongoRecord[RefType]](rec: OwnerType, rm: MongoMetaRecord[RefType])
...
class StringRefField[OwnerType <: MongoRecord[OwnerType], RefType <: MongoRecord[RefType]](rec: OwnerType, rm: MongoMetaRecord[RefType], maxLen: Int)
...
class IntRefField[OwnerType <: MongoRecord[OwnerType], RefType <: MongoRecord[RefType]](rec: OwnerType, rm: MongoMetaRecord[RefType])
...
class LongRefField[OwnerType <: MongoRecord[OwnerType], RefType <: MongoRecord[RefType]](rec: OwnerType, rm: MongoMetaRecord[RefType])
